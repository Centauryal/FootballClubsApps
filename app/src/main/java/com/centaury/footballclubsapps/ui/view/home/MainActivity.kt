...
import com.centaury.footballclubsapps.ui.adapter.PremierLeagueAdapter
...
class MainActivity : AppCompatActivity(), MainView {
    ...
    private lateinit var adapter: PremierLeagueAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = PremierLeagueAdapter(teams)
